...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
   ...
   $sleep = isset($_POST['sleep']) && $_POST['sleep'] !== '' ? floatval($_POST['sleep']) : 0;
   $steps = isset($_POST['steps']) && $_POST['steps'] !== '' ? intval($_POST['steps']) : 0;
   $water = isset($_POST['water']) && $_POST['water'] !== '' ? intval($_POST['water']) : 0;
   $active_minutes = isset($_POST['active_minutes']) && $_POST['active_minutes'] !== '' ? intval($_POST['active_minutes']) : 0;
   $outdoor_time = isset($_POST['outdoor_time']) && $_POST['outdoor_time'] !== '' ? floatval($_POST['outdoor_time']) : 0;
