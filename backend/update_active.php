...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $daily_active_goal = isset($_POST['daily_active_goal']) && $_POST['daily_active_goal'] !== '' ? intval($_POST['daily_active_goal']) : null;

    error_log("Received - Daily Active Minutes Goal: " . ($daily_active_goal ?? 'Not provided'));

    // Check if at least one field is provided
    if ($daily_active_goal === null) {
